...
{
    class LookupValueActivitySettingsPart : BaseActivitySettingsPart
    {
        ...
        public override Activity GenerateActivityOnWorkflow(SequentialWorkflow workflow)
        {
            ...
            LookupValueActivity LookupActivity = new LookupValueActivity();
        ...
        public override void LoadActivitySettings(Activity activity)
        {
            ...
            LookupValueActivity thisActivity = activity as LookupValueActivity;
